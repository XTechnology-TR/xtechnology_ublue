...
COPY --from=ghcr.io/ublue-os/config:latest /files/ublue-os/fish /
COPY --from=ghcr.io/ublue-os/config:latest /files/ublue-os/modprobe.d /
COPY --from=ghcr.io/ublue-os/config:latest /files/ublue-os/dracut.conf.d /
